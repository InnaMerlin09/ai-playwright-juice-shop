...
export async function selectFirstAddress(page: Page): Promise<void> {
    await click(page.locator(selectors.radioButton).first());
}

export async function continueFromAddress(page: Page): Promise<void> {
    await click(page.locator(selectors.proceedToPaymentButton));
}

export async function selectFirstDeliveryOption(page: Page): Promise<void> {
    await click(page.locator(selectors.radioButton).first());
}

export async function continueFromDelivery(page: Page): Promise<void> {
    await click(page.locator(selectors.proceedToDeliveryButton));
}

export async function selectFirstPaymentCard(page: Page): Promise<void> {
    await click(page.locator(selectors.radioButton).first());
}

export async function continueFromPayment(page: Page): Promise<void> {
