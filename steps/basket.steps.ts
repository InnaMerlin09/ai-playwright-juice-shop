...
Given(
    'the user has {string} in the basket',
    async ({ page }, product: string) => {
...
When(
    'the user adds {string} to the basket',
    async ({ page }, product: string) => {
...
When(
    'the user increases the quantity of {string}',
    async ({ page }, product: string) => {
...
Then(
    'the basket notification confirms {string} was added',
    async ({ page }, product: string) => {
...
Then(
    'the quantity of {string} in the basket is {string}',
    async ({ page }, product: string, expectedQuantity: string) => {
